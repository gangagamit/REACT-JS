...
function ProductDetails() {
    const { id } = useParams();
    let Pdata = ProductData.find((item) => item.id === parseInt(id))
    return (
        <div>
            ...
            <div className='shop-details'>
                <div className='p-10'>
                    <p className='text-start'>Shop Details</p>
                    <p className='font-bold text-4xl text-start mt-5'>Shop____Details</p>
                </div>
            </div>
            <div className='flex gap-10 mt-10 justify-center'>
                <div className='img-1'>
                    <img src={Pdata.FirstImg} alt='image'></img>
                </div>
                <div className='text1 mt-10'>
                    ...
                    <div className='n-text flex mt-5'>
                        <p className='text-4xl font bold'>{Pdata.name}</p>
                    ...
                    <div className='p-text flex text-start'>
                        ...
                        <p className='text-4xl font-bold text-red-700'>{Pdata.price}</p>
                    </div>
